...
senha.addEventListener("input", ()=>{
    // 1. Limpa a mensagem
    msgSenhaContainer.textContent = "";
    msgSenhaContainer.style.color = "initial";
    ...
    if (senhaValue.length <= 8 || !num || !le || !min || !mai || !simb){
        msgSenhaContainer.innerHTML = "Nivel de segurança muito baixo. <br>Considere usar ao menos: <br>-- 5 numeros<br> -- 3 letras(entre maiusculas e minusculas)<br> -- 1 caractere especial";
        msgSenhaContainer.style.color = "red";
        senhaValid = false;
    } else{
        msgSenhaContainer.innerHTML = "Senha Forte";
        msgSenhaContainer.style.color = "green";
        senhaValid = true;
    }
    btnAtualiza();
});
